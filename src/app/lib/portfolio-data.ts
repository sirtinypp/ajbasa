...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    {
      slug: 'facial-dtr',
      title: 'Biometric DTR Intelligence',
      role: 'Lead Architect',
      description: 'Facial recognition attendance system ensuring identity verification and eliminating time-theft.',
      longDescription: 'Custom biometric attendance engine that utilizes facial landmark detection to verify identity for clock-in/out events. Designed for high-security environments where physical card-swapping is a risk.',
      features: [
        'Liveness Detection: Prevents spoofing using photos or videos',
        'Identity Hashing: Secure biometric data storage without saving raw images',
        'Automated Payroll Sync: Direct integration into institutional attendance records',
      ],
      impact: [
        'Zero Proxy Clock-ins: Eliminated attendance fraud across monitored units',
        'High Throughput: Verified and logged attendance in under 1.2 seconds per user',
      ],
      tags: ['Python', 'OpenCV', 'React', 'FastAPI'],
    ...
    },
    {
      ...
      role: 'Full-Stack Developer',
      description: 'Real-time telemetry and infrastructure monitoring for enterprise systems.',
      longDescription: 'A centralized command dashboard that aggregates metrics from across various server nodes and service APIs, providing a unified view of system health and uptime.',
      features: [
        'Live Telemetry: Sub-second updates via WebSocket streams',
        'Threshold Alerts: Instant notifications for service interruptions',
        'Historical Analytics: Trend mapping for long-term capacity planning',
      ],
      impact: [
        'Reduced Downtime: 40% faster incident response through visual alerting',
        'Predictive Maintenance: Identified server bottlenecks before failure',
      ],
      tags: ['Next.js', 'Chart.js', 'WebSockets', 'Tailwind'],
    ...
    {
      slug: 'event-systems',
      title: 'QR Event Registration Suite',
      role: 'Systems Architect',
      description: 'Automated end-to-end event management with QR check-in and digital ticketing.',
      longDescription: 'A streamlined workflow for large-scale institutional events, handling everything from registration to real-time on-site verification through secure QR codes.',
      features: [
        'QR Generation Engine: Unique encrypted keys for every attendee',
        'Instant Scan-to-Log: High-speed gate check-in via mobile application',
        'Automated Certificates: Post-event certificate generation and delivery',
      ],
      impact: [
        'Efficiency: Reduced registration queues by 85% for major summits',
        'Data Accuracy: Automated guest lists with real-time occupancy tracking',
      ],
      tags: ['Next.js', 'Supabase', 'Resend', 'QR Logic'],
    ...
    {
      slug: 'record-mgmt',
      title: 'Enterprise Record Manager',
      role: 'Low-Code Specialist',
      description: 'SharePoint-integrated record management system for institutional document lifecycles.',
      longDescription: 'An enterprise-grade Power App designed to modernize document handling, utilizing SharePoint as a secure backend for multi-tier approval and storage.',
      features: [
        'SharePoint Integration: Native document mapping and storage policies',
        'Automated Metadata: Smart tagging for improved search discoverability',
        'Lifecycle Compliance: Automated archiving and deletion protocols',
      ],
      impact: [
        'Governance: Standardized document handling across 10+ administrative units',
        'Searchability: 60% reduction in time spent retrieving historical records',
      ],
      tags: ['Power Apps', 'SharePoint', 'Power Automate', 'M365'],
    ...
    {
      slug: 'mood-tracker',
      title: 'Attendance + Mood Monitor',
      role: 'AI Developer',
      description: 'Wellness-integrated attendance tracker using emotion analysis.',
      longDescription: 'A unique DTR system that monitors staff wellness by analyzing facial expressions during clock-in to provide HR with high-level mood trends.',
      features: [
        'Emotion Analysis: Real-time sentiment detection via TensorFlow.js',
        'Wellness Dashboard: Aggregated trends to identify team burnout',
        'Privacy-First: Sentiment metrics stored without raw image retention',
      ],
      impact: [
        'Proactive HR: Enabled mental health interventions before turnover occurred',
        'Engagement: Increased staff awareness of workplace wellbeing metrics',
      ],
      tags: ['React', 'TensorFlow.js', 'Supabase', 'Vanilla CSS'],
    ...
    {
      slug: 'comms-monitor',
      title: 'Institutional Comms Suite',
      role: 'Systems Developer',
      description: 'Automated monitoring and ingestion of institutional communications through Power Platform.',
      longDescription: 'A sophisticated monitoring tool that tracks and organizes institutional memos and emails into actionable dashboards for decision-makers.',
      features: [
        'M365 Ingestion: Automated tracking of memos and formal requests',
        'Priority Scoring: Smart flagging of urgent communications',
        'Teams Integration: Direct push notifications for high-priority items',
      ],
      impact: [
        'Transparency: Eliminated "lost" communications through centralized logging',
        'Response Speed: Accelerated inter-office communication turnaround by 35%',
      ],
      tags: ['Power Apps', 'Power Automate', 'Graph API', 'M365'],
    ...
    {
      slug: 'doc-routing',
      title: 'Document Routing Engine',
      role: 'Backend Architect',
      description: 'Real-time tracking of physical and digital document movement across office nodes.',
      longDescription: 'A high-fidelity routing system designed to track the "chain of custody" for critical administrative documents across multiple offices.',
      features: [
        'Node-Based Tracking: Check-in/out logging at every office station',
        'Bottleneck Analysis: Visual mapping of document delays',
        'Status Hub: Real-time progress tracking for administrative requests',
      ],
      impact: [
        'Accountability: Immutable logs of who handled which document and when',
        'Efficiency: Identified and removed 2 major bureaucratic bottlenecks in routing',
      ],
      tags: ['Django', 'HTMX', 'Redis', 'Postgres'],
